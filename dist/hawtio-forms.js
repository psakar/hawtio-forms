            ...
            return {
                ...
                link: function (scope, element, attrs) {
                    scope.$watch('config', function (newConfig) {
                        ...
                        s.keySchema.mode = s.valueSchema.mode = HawtioForms.FormMode.VIEW;
                        s.keySchema.style = s.valueSchema.style = HawtioForms.FormStyle.UNWRAPPED;
...
(function (HawtioForms) {
    HawtioForms._module.factory("SchemaRegistry", ['ControlMappingRegistry', function (mappings) {
            ...
            function addSchemaInternal(name, schema) {
                ...
                _.forIn(listeners, function (listener) {
            ...
            var registry = {
                ...
                addSchema: function (name, schema) {
                    ...
                    _.forIn(schemaClone.properties, function (property) {
